...
![Настройка конфигураций](image/3.jpg){#fig-003 width=70%}

![Настройка пользователей](image/4.jpg){#fig-004 width=70%}

## Домашнее задание 
3. Посмотрим порядок загрузки системы с помощью команды dmesg. (рис. @fig-005).

![Выполнение команды](image/5.jpg){#fig-005 width=70%}
...
![Получение необходимой информации ч.1](image/6.jpg){#fig-006 width=70%}

![Получение необходимой информации ч.2](image/7.jpg){#fig-007 width=70%}
